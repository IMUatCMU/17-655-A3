...
/**
 * Main class for the intrusion controller. Delegates message processing to {@link MonitorMessageHandler}
 *
 * @author Weinan Qiu
 * @since 1.0.0
 */
...
public class IntrusionController extends Device implements InitializingBean {
    ...
    public static void main(String[] args) {
        new SpringApplicationBuilder(IntrusionController.class).headless(false).run(args);
    }
}
