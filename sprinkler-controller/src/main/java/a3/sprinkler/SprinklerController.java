...
/**
 * Main class for the sprinkler controller. Delegates message processing to {@link MonitorMessageHandler}
 *
 * @author Weinan Qiu
 * @since 1.0.0
 */
...
public class SprinklerController extends Device implements InitializingBean {
    ...
    protected String deviceId() {
        return "sprinkler-controller@" + _UUID;
    }
