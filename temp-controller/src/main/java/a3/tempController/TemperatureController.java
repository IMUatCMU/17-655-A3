...
public class TemperatureController extends Device implements InitializingBean {
    ...
    protected String deviceId() {
        return "temperature-controller@" + _UUID;
    }
    ...
    public static void main(String[] args) {
        new SpringApplicationBuilder(TemperatureController.class).headless(false).run(args);
    }
}
