...
/**
 * Main class for the fire alarm controller. Delegates message processing to {@link MonitorMessageHandler}
 *
 * @author Weinan Qiu
 * @since 1.0.0
 */
...
public class FireAlarmController extends Device implements InitializingBean {
    ...
    protected String deviceId() {
        return "fire-alarm-controller@" + _UUID;
    }
